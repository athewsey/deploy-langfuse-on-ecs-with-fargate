...
**Review `cdk.json` context configuration**

Then, check the `context` configuration in `cdk.json`. This contains a range of
settings for the solution including things like container image versions, and
environmental variables for Langfuse components - which you may want to
