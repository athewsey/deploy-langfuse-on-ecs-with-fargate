...
class ECSTaskLangfuseWebStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str,
    ...
    **kwargs) -> None:
    ...
    self.ecs_task_definition = aws_ecs.FargateTaskDefinition(self, "LangfuseWebTaskDef",
      family="langfuse-web",
      task_role=task_role,
      cpu=2*1024,
    ...
    docker_run_args = self.node.try_get_context('langfuse_web_env')
    task_env = {
      **docker_run_args,
    ...
    container = self.ecs_task_definition.add_container("LangfuseWebContainerDef",
